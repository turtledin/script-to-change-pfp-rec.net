...
## How to Use
To use you will need to be logged in to rec.net and have the browser console open.

Next just paste the code from either of the JavaScript files (depending on what you want to change) into the console, and you will be prompted with a text field which requires you to enter the image ID.
